...
#line 1082 "postfix.tab.c"
    break;

  case 7: /* exp: exp exp '+'  */
#line 33 "postfix.y"
                           { (yyval.val) = (yyvsp[-2].val) + (yyvsp[-1].val); }
#line 1088 "postfix.tab.c"
    break;

  case 8: /* exp: exp exp '-'  */
#line 34 "postfix.y"
                           { (yyval.val) = (yyvsp[-2].val) - (yyvsp[-1].val); }
#line 1094 "postfix.tab.c"
    break;
...
#line 1112 "postfix.tab.c"
    break;

  case 11: /* exp: exp exp '^'  */
#line 43 "postfix.y"
                           { (yyval.val) = pow((yyvsp[-2].val), (yyvsp[-1].val)); }
#line 1118 "postfix.tab.c"
    break;

  case 12: /* exp: exp 'n'  */
#line 44 "postfix.y"
                           { (yyval.val) = -(yyvsp[-1].val); }
#line 1124 "postfix.tab.c"
    break;
